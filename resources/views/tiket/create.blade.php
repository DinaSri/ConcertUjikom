<div class="content" id="createFormTiket" style="display: none;">
  <div class="col-md-12">
    <div class="row">
      <div class="card">
        <div class="header">
          ...
          <div class="container-fluid">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control border-input" placeholder="Harga" name="harga" id="harga" required>
            </div>
           ...
           <input type="text" class="form-control border-input" placeholder="Stok" name="stok" id="stok" required>
            ...
            <div class="form-group">
              <label class="control-label">Kategori Tiket</label>
              <select class="form-control border-input" name="katiket_id" id="pilihKatiket" required>
              </select>
            </div>
